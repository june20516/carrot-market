      ...
      <div className="w-full mt-10">
        ...
        <div className="grid grid-cols-2 gap-16 border-b w-full">
          <button
            className={klassName(
              ...
              method === 'email' ? 'text-purple-400  border-purple-500' : 'border-transparent'
            )}
        ...
        <div className="mt-6 p-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="h-10 flex justify-center items-center border border-gray-300 text-gray-500 shadow-sm rounded-md hover:bg-gray-100">
